  ...
  return <aside className="w-64 bg-gray-50 border-r min-h-screen">
      <div className="px-4 py-5">
        <div className="relative">
          ...
          <Input type="search" placeholder="Buscar..." className="pl-10 w-full" />
        </div>
      </div>
      ...
      <div className="mt-2">
        ...
        <div>
          <button onClick={() => toggleSubmenu("programa-nacional")} className="w-full text-left py-2 px-4 font-medium text-sm flex justify-between items-center hover:bg-gray-100">
            <span>PROGRAMA NACIONAL D. P. POLICIAL</span>
            <span>{openSubmenu === "programa-nacional" ? "−" : "+"}</span>
          </button>
          
          {openSubmenu === "programa-nacional" && <div>
              {/* PROGRAMA TECNICO */}
              ...
              toggleSubmenu("programa-tecnico");
                  ...
                  <span className="querio que al hacer click en programa tecnico se despligue con estas opciones\n\n   Descargar 1er DAN\n\n   Descargar 2\xBA DAN\n\n   Descargar 3er DAN">PROGRAMA TÉCNICO</span>
                  <span>{openSubmenu === "programa-tecnico" ? "−" : "+"}</span>
                </button>
                
                {openSubmenu === "programa-tecnico" && <div className="pl-4">
              ...
              toggleSubmenu("katas");
                ...
                {openSubmenu === "katas" && <div className="pl-4">
