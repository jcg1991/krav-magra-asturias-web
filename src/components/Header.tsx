...
const Header = () => {
  return (
    <header className="relative">
      <div className="header-image h-80 w-full bg-contain bg-no-repeat bg-center" style={{ backgroundImage: "url('/lovable-uploads/6e6a574a-0d2a-430f-a06f-17c7c568f105.png')" }}></div>
